  ...
  useEffect(() => {
    ...
    readyQuests.forEach(async (q) => {
      ...
      try {
        ...
        // Refresh list quietly after each auto-completion
        await loadData(true);
        Alert.alert(
          '🎉 Défi accompli !',
    ...
    <View style={[styles.root, { backgroundColor: BG }]}>
      ...
      >
          ...
          >
            {generating ? (
              ...
              <>
                ...
                <Text style={styles.generateBtnText}>Générer de nouveaux défis avec Rixy</Text>
              </>
            )}
          </Pressable>
        )}
        ...
        <Text style={[styles.disclaimer, { color: SUB }]}>
          Les défis sont générés par Rixy et mis à jour selon tes transactions.
        </Text>
      </ScrollView>
    </View>
  );
